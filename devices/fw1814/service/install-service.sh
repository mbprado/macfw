...
PRESERVED_ENV_KEYS=(
    ...
    MACFW_96_ROLLING_TX
    MACFW_96_ROLLING_TX_CYCLES
    MACFW_88_ROLLING_TX
    MACFW_88_ROLLING_TX_CYCLES
    MACFW_88_SHORT_READY_RESERVE
    MACFW_96_SHORT_READY_RESERVE
    MACFW_176_ROLLING_TX
    MACFW_192_ROLLING_TX
    MACFW_192_ROLLING_RING_PACKETS
