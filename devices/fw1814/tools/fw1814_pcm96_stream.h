...
public:
    ...
    BlockingPcmStream96k(BlockingPcmTransmitRing96k& tx,
    ...
    bool valid() const {
        return tx_ && pcm_ && static_cast<bool>(*tx_) && pcm_->valid() &&
               pcm_->channelCount() == BlockingPcmTransmitRing96k::pcmChannels() &&
...
private:
    ...
    void accumulate(const BlockingPcmTransmitRing96k::RefillResult& refill) {
