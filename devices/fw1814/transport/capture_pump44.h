...
// Native 44.1-kHz FW1814 capture decoder. This intentionally mirrors the
// hardware-proven 48-kHz decoder while changing only the expected AM824 FDF
// from 0x02 to 0x01. Stream width and physical channel mapping are unchanged in
// the validated S/PDIF formation: 10 PCM + 1 MIDI, DBS=11.
class CapturePump44100 {
public:
    struct Stats {
