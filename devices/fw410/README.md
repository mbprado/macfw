...
Reverse-engineering and user-space driver/DevKit project for the M-Audio FireWire 410 (FW410). The complete device implementation lives under `devices/fw410/`.
