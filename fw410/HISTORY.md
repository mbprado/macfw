...
Short before/after excerpts from controlled tests 19 and 20 are stored under `pictures/audio/` so the history can preserve the audible progression without committing the multi-megabyte full recordings.
